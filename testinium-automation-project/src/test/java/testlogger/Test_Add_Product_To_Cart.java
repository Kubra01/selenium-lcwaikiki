...
//    @Disabled("Due to BUG-123 disabled")
    ...
    @Test
    @Order(5)
        public void delete_product_in_cart(){
        homePage.goToCart();
        Assertions.assertTrue( cartPage.checkIfProductDelete() ,
               "The product has not been deleted from the cart!" );
        }
